...
public class StudentService {
    ...
    public List<Student> insertStudents() {
        ...
        students.add(new Student("Nipa Howlader", "Class 10", "10"));
        students.add(new Student("Arka Bhuiyan", "Class 9", "8"));
        students.add(new Student("Jewel Chowdhury", "Class 8", "6"));
    ...
    public Student retrieveStudentByName(String name) {
        return repository.findByname(name).orElse(new Student());
