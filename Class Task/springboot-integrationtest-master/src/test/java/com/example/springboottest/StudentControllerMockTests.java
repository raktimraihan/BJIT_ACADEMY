...
public class StudentControllerMockTests {
    ...
    public void testRetrieveStudentWithMockRepository() throws Exception {
        ...
        Optional<Student> optStudent = Optional.of( new Student("Arka Bhuiyan","Class 9", "2"));
    ...
    public void testRetrieveStudent() {
    	...
    	Optional<Student> optional = Optional.of(new Student("Fahim","Class 10","1"));
    	when(studentRepository.findById(1)).thenReturn(optional);
    	
    	assertTrue(studentService.retrieveStudent(1).getName().contains("Fahim"));
