...
public class StudentControllerTests {
    ...
    @Test
    public void testRetrieveStudent01() throws Exception {
        HttpEntity<String> entity = new HttpEntity<String>(null, headers);

        ResponseEntity<String> response = restTemplate.exchange(
          createURLWithPort("/students/3"), HttpMethod.GET, entity, String.class);

        String expected = "{\"id\":3,\"name\":\"Jewel Chowdhury\",\"description\":\"Class 8\",\"classRoll\":\"6\"}";
