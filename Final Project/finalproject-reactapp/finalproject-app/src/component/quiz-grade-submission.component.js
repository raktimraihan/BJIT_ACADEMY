...
//   reviewerName: reviewerUserName
  ...
  function handleRegister(e) {
    ...
    if (checkBtn.context._errors.length === 0) {
      ...
      userService.assignCourseGrading(
            title,
            batchName,
            traineeUserName,
            traineeName,
          ...
          >
            {!successfulFinal && (
              <div className="form-group col-md-10 px-4">
                ...
                <div className="form-group mt-4 px-4">
                  <label htmlFor="courseName">Reviewer Username</label>
                  <Input
                    type="text"
                    className="form-control"
                    name="revieweruserName"
                    value={reviewerUserName}
                    onChange={onChangeReviewUserName}
                ...
                <div className="form-group mt-4 px-4">
                  <label htmlFor="courseName">Reviewer Name</label>
                  <Input
                    type="text"
                    className="form-control"
                    name="reviewerName"
                ...
                <div className="form-group mt-4 px-4">
                  <label htmlFor="courseName">Attained Marks</label>
                  <Input
                    type="text"
                    className="form-control"
                    name="attainedMarks"
                    value={attainedMarks}
                    onChange={onChangeAttainedMarks}
                    validations={[required]}
...
export default QuizGradeSubmission;