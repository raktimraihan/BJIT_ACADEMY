...
export default class TrainerRegistration extends Component {
  constructor(props) {
    ...
    this.getBatchesSchedule = this.getBatchesSchedule.bind(this);
  ...
  getBatchesSchedule() {
    userService
      .getBatchesSchedule()
      .then((result) => this.setState({ courseOption: result.data }));
              ...
              <div>
                ...
                <div className="form-group mt-4 px-4">
                  ...
                  <Select
                    ...
                    className="form-control"
                  >
                    <option value="">Choose Designated Course</option>
                      <OptionMapper axiosMethod={userService.getBatchesSchedule()} />                    
